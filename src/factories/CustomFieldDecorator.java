...
public class CustomFieldDecorator {
	...
	public Object decorate(ClassLoader loader, Field field) {
		if (!(ControlBase.class.isAssignableFrom(field.getType()) || isDecoratableList(field))) {
			return null;
		}
		...
		if (ControlBase.class.isAssignableFrom(field.getType())) {
			return proxyForLocator(loader, locator);

		} else if (components.Button.class.isAssignableFrom(field.getType())) {
			return proxyForLocator(loader, locator);
